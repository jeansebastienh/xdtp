@echo off
REM XdebugTraceParser
REM 
REM Copyright (c) 2009-2011, Jean-Sebastien Hedde <jeanseb@au-fil-du.net>.
...
REM    distribution.
REM 
REM  * Neither the name of Jean-Sebastien Hedde nor the names of his
