...
require_once 'Afdn/Xdebug/ExecutionNode/Decorator/Text.php';
require_once 'Afdn/Xdebug/ExecutionNode.php';
/**
 * Afdn_Xdebug_ExecutionNode_Decorator_TextTest
 *
 * @category   AfdnFramework
 * @package    Xdebug
 * @subpackage Trace
 ...
 * @license    http://www.opensource.org/licenses/bsd-license.php  BSD License
 */
class Afdn_Xdebug_ExecutionNode_Decorator_TextTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Afdn_Xdebug_ExecutionNode_Decorator_Text
     */
    ...
    {
        $this->_decorator = new Afdn_Xdebug_ExecutionNode_Decorator_Text();
    ...
    {
        $this->assertEquals(file_get_contents(dirname(__FILE__) . '/_files/no-children.txt'), $this->_decorator->decorate($this->_node));
    }
    ...
    public function testDecorateWithOneChild()
    {
        ...
        $this->assertEquals(file_get_contents(dirname(__FILE__) . '/_files/one-child.txt'), $this->_decorator->decorate($this->_node));
    }
}